...
handler.all = async function (m) {
   ...
   global.rpl = { contextInfo: { externalAdReply: { mediaUrl: dygp, mediaType: 'VIDEO', description: 'group suport', title: packname, body: 'group dukungan', thumbnailUrl: pp, sourceUrl: dygp }}} 
	...
	//reply link yt
    global.rpyt = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: fgyt, mediaType: 'VIDEO', description: 'Suscribete : ' + fgyt, title: 'NZ YouTube', body: 'Terima kasih', thumbnailUrl: pp, sourceUrl: fgyt }}}
